...
import QuanLyFastFood.BUS.PhanQuyenBUS;
import QuanLyFastFood.DTO.PhanQuyen;
...
//main
    public MainQuanLyGUI() {
        this.setTitle("Phần mềm quản lý FastFood");
        this.setSize(1520, 800);
    ...
    JLabel btnClose, btnMinimize, lblBanHang,lbltest, lblKhuyenMai, lblNhapHang, lblSanPham, lblNhanVien, lblKhachHang, lblThongKe;
        ...
        for (JLabel lbl : listMenuLeft) {
            lbl.addMouseListener(new MouseListener() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    // Xử lý lật trang theo menu check index
