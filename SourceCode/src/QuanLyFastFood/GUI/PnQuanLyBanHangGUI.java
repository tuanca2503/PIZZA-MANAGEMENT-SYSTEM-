package QuanLyFastFood.GUI;

import QuanLyFastFood.DTO.LoaiSP;
import QuanLyFastFood.DTO.HoaDon;
import QuanLyFastFood.DTO.SanPham;
import QuanLyFastFood.DTO.CTHoaDon;
import QuanLyFastFood.DTO.NhanVien;
import QuanLyFastFood.BUS.LoaiBUS;
import QuanLyFastFood.BUS.NhanVienBUS;
import QuanLyFastFood.BUS.HoaDonBUS;
import QuanLyFastFood.BUS.CTHoaDonBUS;
import QuanLyFastFood.BUS.DangNhapBUS;
import QuanLyFastFood.BUS.SanPhamBUS;
...
//        pnNhanVienBan.add(cmbNhanVienBan);
        ...
        lblAnhSP.setPreferredSize(new Dimension(200, 150));
        ...
        pnLeftBanHang.setPreferredSize(new Dimension(868, h - 141));
        pnTableBanHang.setPreferredSize(new Dimension(668, (h - 41) / 2));
...
//ok
        pnThongTinBanHang.setPreferredSize(new Dimension((int) pnRightBanHang.getPreferredSize().getWidth(),
                (int) pnTableBanHang.getPreferredSize().getHeight()+20));
        ...
        pnCTHoaDonLeft.setPreferredSize(new Dimension(520,
